...
type UserInitParameters struct {
	ChangePasswordRequired *bool `json:"changePasswordRequired,omitempty" tf:"change_password_required,omitempty"`
...
// User is the Schema for the Users API. Neo4j user
